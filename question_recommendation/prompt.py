...
- 当前提问希望查询网络设备的“CPU利用率”，但网络设备没有“CPU利用率”指标。推荐先
  查看网络设备基础信息和数量，再选择该对象已有的指标继续查询。
- 当前提问希望查询服务器风扇的“状态”属性，但服务器的风扇没有“状态”属性。推荐先
  查看风扇列表和基础信息，确认可查询的风扇属性。
- 当前提问使用了无法确定具体名称的字段，但该类型网络设备没有该字段。推荐先查看网络
  设备基础信息，再选择可查询的属性继续提问。
