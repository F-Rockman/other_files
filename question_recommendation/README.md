...
`explain` 不写成错误分析报告、拒答复述或推荐系统处理日志，而是自然衔接用户下一步。
默认使用一句话，直接说明推荐问题可以帮助用户从哪些方向继续确认；只有确实需要表达
先后步骤时才使用两句。无需完整复述原问题，也不解释系统为什么选择这些推荐。

禁止使用“错误原因是”“失败原因是”“推荐调整为”“建议调整为”“推荐方向是”
“基于上述原因”“针对该错误”“系统建议”“支持查看”“可查看”等报告式、能力说明式
或流程式表达，也不复述“当前查询涉及多个业务域”“建议选择具体设备类型”等拒答内容。
优先自然说明不同对象的信息差异，并使用“可以先……”“可以分别……”“先确认……后再……”
等行动表达，但不要机械复用同一句式。
